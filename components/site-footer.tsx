    ...
    <footer className="relative border-t border-white/10 bg-black/30 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 py-10 text-center md:flex-row md:justify-between md:px-6 md:text-left">
        <div className="flex items-center gap-3">
          <span className="relative flex h-8 w-8 items-center justify-center overflow-hidden rounded-full ring-1 ring-white/20">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-muted-foreground">
          <a href="#play" className="transition hover:text-foreground">Spielen</a>
          <a href="#how" className="transition hover:text-foreground">Anleitung</a>
          <a href="#socials" className="transition hover:text-foreground">Connect</a>
          <a href="#faq" className="transition hover:text-foreground">FAQ</a>
          <a href="#about" className="transition hover:text-foreground">Über</a>
        </nav>
        ...
        <a
          ...
          className="group inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2.5 text-sm font-semibold text-foreground backdrop-blur-xl transition hover:bg-white/20 hover:ring-2 hover:ring-white/30"
        >
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
